...
public class InkBlobProjectile extends ProjectileEntity {
    public InkBlobProjectile(EntityType<? extends ProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public InkBlobProjectile(PlayerEntity player, World world) {
        super(InkExpansion.INK_BLOB_PROJECTILE, world);
    ...
    private void damageNearby() {
        for (LivingEntity living : this.getWorld().getEntitiesByClass(LivingEntity.class, Box.of(this.getPos(),
            ...
            float damage = 7f * (4f - (float)this.getPos().distanceTo(living.getPos())) / 4f;
