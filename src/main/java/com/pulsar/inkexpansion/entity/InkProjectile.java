...
public class InkProjectile extends ProjectileEntity {
    public InkProjectile(EntityType<? extends ProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public InkProjectile(PlayerEntity player, World world) {
    ...
    protected void onBlockHit(BlockHitResult blockHitResult) {
        ...
        if (this.getWorld().getBlockState(pos).isReplaceable() || this.getWorld().getBlockState(pos).isOf(DefileBlocks.FUNERAL_INK)) {
            BlockState state = this.getWorld().getBlockState(pos).isOf(DefileBlocks.FUNERAL_INK) ? this.getWorld().getBlockState(pos) : DefileBlocks.FUNERAL_INK.getDefaultState();
